...
const TradeDayNightSection = () => {
  ...
  return (
    ...
    >
      ...
      >
        <motion.div
          className="flex items-center space-x-4 px-6 py-3 rounded-full backdrop-blur-md border border-white/10"
          style={{
            backgroundColor: useTransform(dayNightProgress, (v) =>
              v > 0.5 ? "rgba(0, 0, 0, 0.2)" : "rgba(255, 255, 255, 0.2)"
            ),
          }}
        >
          <motion.div
          ...
          <motion.span
            style={{
              color: useTransform(dayNightProgress, (v) =>
                v > 0.5 ? "#ffffff" : "#1f2937"
              ),
            }}
          ...
          >
            ...
            >
              Trade 24/7 on exclusive markets
            </motion.span>
            <motion.span
              style={{
                opacity: nightBackgroundOpacity,
            ...
            >
              Markets available day and night
            </motion.span>
            <span className="invisible">Markets available day and night</span>
          </motion.span>
        </motion.div>
      </motion.div>
    </section>
